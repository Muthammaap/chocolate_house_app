...
if option == "View Flavors":
    ...
    flavor_name = st.text_input("Enter name of the flavor:")
    seasonal = st.radio("whether the flavour seasonal", ("Yes=1", "No=0"))
    ...
    display_flavors()
    flavor_id = st.number_input("Enter the flavor ID to be  deleted:", min_value=1, step=1)
    ...
    display_flavors()
    flavor_id = st.number_input("Enter floavor ID to be updated:", min_value=1, step=1)
    new_flavor_name = st.text_input("Enter new flavor name:")
    new_seasonal = st.radio("whether the flavour seasonal?", ("Yes=1", "No=0"))
...
# Ingredient Management
    ...
    if sub_option == "View Ingredients":
        ...
        display_ingredients()
        ingredient_id = st.number_input("Enter the ingredient ID to be updated:", min_value=1, step=1)
